...
export const demoEmails: Email[] = [
  {
    ...
    replyOptions: [{ content: "I'll be there" }, { content: "Can't make it" }],
  ...
  },
  {
    ...
    replyOptions: [{ content: "Confirmed" }, { content: "Reschedule needed" }],
  ...
  },
  {
    ...
    replyOptions: [{ content: "Sign me up" }, { content: "Not interested" }],
